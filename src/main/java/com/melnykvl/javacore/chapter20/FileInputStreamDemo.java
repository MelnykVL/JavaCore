...
public class FileInputStreamDemo {
    public static void main(String[] args) {
        ...
        try (FileInputStream f = new FileInputStream("src/main/java/com/melnykvl/javacore/chapter20/FileInputStreamDemo.java")) {
            ...
            System.out.println("Чтение слудующих " + n + " байтов по очереди методом read(b[])");
            byte b[] = new byte[n];
            if (f.read(b) != n) {
